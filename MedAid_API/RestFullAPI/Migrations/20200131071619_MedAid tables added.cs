...
{
    public partial class MedAidtablesadded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreLatLong = table.Column<string>(nullable: true),
                    StoreLocationTitle = table.Column<string>(nullable: true),
                    StoreContactNo = table.Column<string>(nullable: true),
                    StoreEmailAddress = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    LocationShortName = table.Column<string>(nullable: true),
                    LocationTitle = table.Column<string>(nullable: true),
                    LocationLatLong = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlarmTimesCommaSeprated = table.Column<string>(nullable: true),
                    FromLocationLatLong = table.Column<string>(nullable: true),
                    ToLocationLatLong = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaltFormula = table.Column<string>(nullable: true),
                    Brand = table.Column<string>(nullable: true),
                    ForDiseas = table.Column<string>(nullable: true),
